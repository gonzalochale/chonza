...
***Note:*** The logos used in the preview are for demonstration purposes only, they were taken from [svgl.app](https://svgl.app/).
...
Copy the following code to your component ***testimonials.tsx***.
