...
Copy and paste the following code into your component, example **_hero.tsx_**.
...
function Hero() {
  return (
    <section className="relative w-full max-w-5xl mx-auto flex flex-col justify-center items-center gap-8 bg-[#0D0D0C] py-24">
